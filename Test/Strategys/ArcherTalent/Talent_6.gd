...
func apply_upgrade(projectile: Node) -> void:
	print("Aplicando upgrade de Flaming Arrows!")
	...
	# Os metadados específicos de DoT serão configurados no ConsolidatedTalentSystem
	print("Flaming Arrows aplicado ao projétil")
